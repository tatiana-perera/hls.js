...
declare type ErrorControllerConfig = {
    /**
...
export declare interface HlsIFramesOnly extends Hls {
...
export declare type LicenseAndKeysRequest = EventEmitter & {
...
export declare const enum LoaderContextType {
    MANIFEST = "manifest",
    LEVEL = "level",
...
declare type LoadMediaAtOptions = {
